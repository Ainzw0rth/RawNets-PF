...
from classes.FeatureDataset.PathoFeatureDataset import PathoFeatureDataset
...
if __name__ == "__main__":
    ...
    log_filename = f"logs/train/train_log_patho_{timestamp}.txt"
    ...
    full_dataset = PathoFeatureDataset("preprocessed_data/patho")
    print("\n==================== DATASET LOADED ====================\n")
        ...
        for batch_size in batch_sizes:
            ...
            for lr_idx, learning_rate in enumerate(learning_rates):
                ...
                train_rawnet1_with_loaders(model, train_loader, val_loader, 
                                        device=device, epochs=epochs, lr=learning_rate, start_epoch=0, variation="patho")
