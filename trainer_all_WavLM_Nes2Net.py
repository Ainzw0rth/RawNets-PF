...
# Import WavLM-Nes2Net components
from classes.models.WavLM_Nes2Net.model_WavLM_Nes2Net import WavLMNes2Net
from classes.models.WavLM_Nes2Net.trainer_WavLM_Nes2Net import (
    train_wavlm_nes2net_with_loaders,
    test_wavlm_nes2net,
...
if __name__ == "__main__":
    ...
    log_filename = f"logs/train/train_log_wavlm_nes2net_{timestamp}.txt"
    ...
    try:
        for batch_size in batch_sizes:
            ...
            for lr_idx, learning_rate in enumerate(learning_rates):
                ...
                model = WavLMNes2Net(args=args, device=device).to(device)
                ...
                predictions, targets, metrics = test_wavlm_nes2net(model, test_loader, device=device)
