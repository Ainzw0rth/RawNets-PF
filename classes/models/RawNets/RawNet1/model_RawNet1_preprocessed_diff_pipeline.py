...
class RawNet(nn.Module):
	...
	def forward(self, features, is_test=False):
		...
		# features shape: (batch_size, 64024)
		x_waveform = features[:, :64000]  # (batch_size, 64000)
		x_patho = features[:, 64000:]  # (batch_size, 24)

		x_waveform = x_waveform.unsqueeze(1)  # [B, 1, 64000]
		x_waveform = self.first_conv(x_waveform)
