...
if __name__ == "__main__":
    ...
    log_filename = f"logs/train/train_log_xlsr_conformer_tcm_{timestamp}.txt"
    ...
    try:
        for batch_size in batch_sizes:
            ...
            for lr_idx, learning_rate in enumerate(learning_rates):
                ...
                model = XLSRConformerTCM(model_config, device).to(device)
                ...
                # Train XLSR-Conformer with TCM
                print("\n=== Training XLSR-Conformer with TCM ===")
                train_xlsr_conformer_tcm_with_loaders(
                    model, 
                    train_loader, 
                    val_loader, 
                ...
                # Test XLSR-Conformer with TCM
                print("\n--- Testing XLSR-Conformer with TCM ---")
