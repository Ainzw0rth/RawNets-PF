...
def train_rawnet2_with_loaders(model, train_loader, val_loader=None, test_loader=None, class_labels=None, device="cuda", epochs=40, lr=0.001):
    ...
    if test_loader:
        test_rawnet2(model, test_loader, class_labels, device)
